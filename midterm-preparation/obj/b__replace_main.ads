...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_replace_main" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#c1d5e632#;
   pragma Export (C, u00001, "replace_mainB");
   ...
   u00121 : constant Version_32 := 16#c7cb861d#;
   pragma Export (C, u00121, "replace_gB");
   u00122 : constant Version_32 := 16#e4bbd420#;
   pragma Export (C, u00122, "replace_gS");

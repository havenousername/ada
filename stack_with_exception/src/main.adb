with Stackgen, Ada.Text_IO, Ada.Integer_Text_IO;
use Ada.Text_IO, Ada.Integer_Text_IO;

procedure Main is
   package IStacks is new Stackgen(Integer);
   use IStacks;
   Max: Integer;
   ...
   procedure Menu(V: in out Stack) is
      ...
      procedure Insert(V: in out Stack) is
         data: Integer;
      begin
         Put("What would you like to insert? ");
         Get(data);
         Push(V, data);
      exception
         when Full_Stack =>

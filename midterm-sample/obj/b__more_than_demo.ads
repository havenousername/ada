...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_more_than_demo" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#c6f09c65#;
   pragma Export (C, u00001, "more_than_demoB");
   ...
   u00121 : constant Version_32 := 16#6cc0bfde#;
   pragma Export (C, u00121, "more_thanB");
   u00122 : constant Version_32 := 16#cd543d3c#;
   pragma Export (C, u00122, "more_thanS");

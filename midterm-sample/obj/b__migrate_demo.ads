...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_migrate_demo" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#f4046752#;
   pragma Export (C, u00001, "migrate_demoB");
   ...
   u00121 : constant Version_32 := 16#7f5aa8ab#;
   pragma Export (C, u00121, "migrateB");
   u00122 : constant Version_32 := 16#8f8b5c54#;
   pragma Export (C, u00122, "migrateS");

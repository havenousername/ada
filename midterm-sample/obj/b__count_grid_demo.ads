...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_count_grid_demo" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#6d478635#;
   pragma Export (C, u00001, "count_grid_demoB");
   ...
   u00121 : constant Version_32 := 16#bf15535c#;
   pragma Export (C, u00121, "count_gridB");
   u00122 : constant Version_32 := 16#eae5f8a8#;
   pragma Export (C, u00122, "count_gridS");

...
package ada_main is
   ...
   u00001 : constant Version_32 := 16#74fde8ce#;
   ...
   u00091 : constant Version_32 := 16#f2c63a02#;
   pragma Export (C, u00091, "ada__numericsS");
   u00092 : constant Version_32 := 16#8c178268#;
   pragma Export (C, u00092, "ada__strings__text_buffersB");
   u00093 : constant Version_32 := 16#0800bb5e#;
   pragma Export (C, u00093, "ada__strings__text_buffersS");
   u00094 : constant Version_32 := 16#cd3494c7#;
   pragma Export (C, u00094, "ada__strings__utf_encodingB");
   u00095 : constant Version_32 := 16#37e3917d#;
   pragma Export (C, u00095, "ada__strings__utf_encodingS");
   u00096 : constant Version_32 := 16#d1d1ed0b#;
   pragma Export (C, u00096, "ada__strings__utf_encoding__wide_stringsB");
   u00097 : constant Version_32 := 16#103ad78c#;
   pragma Export (C, u00097, "ada__strings__utf_encoding__wide_stringsS");
   u00098 : constant Version_32 := 16#c2b98963#;
   pragma Export (C, u00098, "ada__strings__utf_encoding__wide_wide_stringsB");
   u00099 : constant Version_32 := 16#91eda35b#;
   pragma Export (C, u00099, "ada__strings__utf_encoding__wide_wide_stringsS");
   u00100 : constant Version_32 := 16#b3f0dfa6#;
   pragma Export (C, u00100, "ada__tagsB");
   u00101 : constant Version_32 := 16#cb8ac80c#;
   pragma Export (C, u00101, "ada__tagsS");
   u00102 : constant Version_32 := 16#5534feb6#;
   pragma Export (C, u00102, "system__htableB");
   u00103 : constant Version_32 := 16#ab38e2fe#;
   ...
   u00111 : constant Version_32 := 16#52d4e162#;
   ...
   u00115 : constant Version_32 := 16#066a78a0#;
   pragma Export (C, u00115, "interfaces__c_streamsS");
   u00116 : constant Version_32 := 16#30f1a29e#;
   pragma Export (C, u00116, "system__file_ioB");
   u00117 : constant Version_32 := 16#888bb071#;
   ...
   u00120 : constant Version_32 := 16#60082284#;
   ...
   u00122 : constant Version_32 := 16#0774605b#;
   pragma Export (C, u00122, "system__random_numbersB");
   u00123 : constant Version_32 := 16#19a1600c#;
   pragma Export (C, u00123, "system__random_numbersS");
   u00124 : constant Version_32 := 16#15692802#;
   pragma Export (C, u00124, "system__random_seedB");
   u00125 : constant Version_32 := 16#c3b30278#;
   pragma Export (C, u00125, "system__random_seedS");
   u00126 : constant Version_32 := 16#48583e4e#;
   pragma Export (C, u00126, "ada__calendarB");
   u00127 : constant Version_32 := 16#31350a81#;
   pragma Export (C, u00127, "ada__calendarS");
   u00128 : constant Version_32 := 16#24ec69e6#;
   pragma Export (C, u00128, "system__os_primitivesB");
   u00129 : constant Version_32 := 16#280734e2#;
   pragma Export (C, u00129, "system__os_primitivesS");
   u00130 : constant Version_32 := 16#2f9cb76c#;
   pragma Export (C, u00130, "system__arith_64B");
   u00131 : constant Version_32 := 16#9d9eabfb#;
   pragma Export (C, u00131, "system__arith_64S");
   u00132 : constant Version_32 := 16#05c60a38#;
   pragma Export (C, u00132, "system__task_lockB");
   u00133 : constant Version_32 := 16#4e70667a#;
   pragma Export (C, u00133, "system__task_lockS");
   u00134 : constant Version_32 := 16#b8c476a4#;
   pragma Export (C, u00134, "system__win32__extS");
   u00135 : constant Version_32 := 16#a5b55d2f#;
   pragma Export (C, u00135, "system__val_unsS");
   u00136 : constant Version_32 := 16#96c62183#;
   pragma Export (C, u00136, "system__taskingB");
   u00137 : constant Version_32 := 16#256a579d#;
   pragma Export (C, u00137, "system__taskingS");
   u00138 : constant Version_32 := 16#0c334715#;
   pragma Export (C, u00138, "system__task_primitivesS");
   u00139 : constant Version_32 := 16#4e3ebb7e#;
   pragma Export (C, u00139, "system__os_interfaceS");
   u00140 : constant Version_32 := 16#0039537b#;
   pragma Export (C, u00140, "interfaces__c__stringsB");
   u00141 : constant Version_32 := 16#eda3d306#;
   pragma Export (C, u00141, "interfaces__c__stringsS");
   u00142 : constant Version_32 := 16#cc709166#;
   pragma Export (C, u00142, "system__task_primitives__operationsB");
   u00143 : constant Version_32 := 16#9723968e#;
   ...
   u00145 : constant Version_32 := 16#cf061228#;
   ...
   u00157 : constant Version_32 := 16#248a0db1#;
   pragma Export (C, u00157, "system__concat_3S");
   u00158 : constant Version_32 := 16#617d5887#;
   pragma Export (C, u00158, "system__stack_usageB");
   u00159 : constant Version_32 := 16#8d63b971#;
   pragma Export (C, u00159, "system__stack_usageS");
   u00160 : constant Version_32 := 16#ac06ab59#;
   pragma Export (C, u00160, "system__tasking__protected_objectsB");
   u00161 : constant Version_32 := 16#242da0e0#;
   pragma Export (C, u00161, "system__tasking__protected_objectsS");
   u00162 : constant Version_32 := 16#2e7731ce#;
   pragma Export (C, u00162, "system__soft_links__taskingB");
   u00163 : constant Version_32 := 16#e939497e#;
   pragma Export (C, u00163, "system__soft_links__taskingS");
   u00164 : constant Version_32 := 16#3880736e#;
   pragma Export (C, u00164, "ada__exceptions__is_null_occurrenceB");
   u00165 : constant Version_32 := 16#5ca174ae#;
   pragma Export (C, u00165, "ada__exceptions__is_null_occurrenceS");
   u00166 : constant Version_32 := 16#79a87c8f#;
   pragma Export (C, u00166, "toolsB");
   u00167 : constant Version_32 := 16#5d71cd7d#;
   pragma Export (C, u00167, "toolsS");

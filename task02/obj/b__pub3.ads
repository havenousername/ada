...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_pub3" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#0de55892#;
   pragma Export (C, u00001, "pub3B");
   ...
   u00158 : constant Version_32 := 16#ac06ab59#;
   pragma Export (C, u00158, "system__tasking__protected_objectsB");
   u00159 : constant Version_32 := 16#242da0e0#;
   pragma Export (C, u00159, "system__tasking__protected_objectsS");
   ...
   u00164 : constant Version_32 := 16#d5216b8e#;
   ...
   u00167 : constant Version_32 := 16#45aa48e1#;
   pragma Export (C, u00167, "system__restrictionsS");
   u00168 : constant Version_32 := 16#d499f4ac#;
   pragma Export (C, u00168, "system__tasking__initializationB");
   u00169 : constant Version_32 := 16#cd0eb8a9#;
   pragma Export (C, u00169, "system__tasking__initializationS");
   ...
   u00172 : constant Version_32 := 16#ef7f0714#;
   pragma Export (C, u00172, "system__tasking__protected_objects__operationsB");
   u00173 : constant Version_32 := 16#07408f44#;
   ...
   u00180 : constant Version_32 := 16#2ebb1120#;
   pragma Export (C, u00180, "system__tasking__rendezvousB");
   u00181 : constant Version_32 := 16#da433d5e#;
